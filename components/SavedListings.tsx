  ...
  if (listings.length === 0) {
    return (
        <div className="text-center py-10">
            ...
            <p className="mt-4 text-sm font-semibold text-gray-700 dark:text-gray-300">No Saved Listings</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Click the star icon on a generated listing to save it here.</p>
        </div>
    );
  }
