...
export const SavedListings: React.FC<SavedListingsProps> = React.memo(({ listings, onSelect, onDelete, onEdit, activeItemId, hasSearchQuery }) => {
    ...
    return (
        <div className="text-center py-10">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
                 {hasSearchQuery ? 'Try a different search term.' : 'Click "Save Listing" on a generated item to keep it here.'}
            </p>
        </div>
    );
  }
        ...
        return (
          <div key={item.id} className="group flex items-center gap-2">
            ...
            <div className="flex opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                    onClick={() => onEdit(item)}
                    className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-500 hover:text-primary"
                    aria-label="Edit saved listing"
                >
                ...
                <button 
                    ...
                    className="p-2 rounded-full hover:bg-red-100 dark:hover:bg-red-900/50 text-gray-500 hover:text-red-500"
